...
DROP TABLE IF EXISTS DBA.ColumnDefaultAndChecks

CREATE TABLE DBA.ColumnDefaultAndChecks(
	  [DatabaseName][VARCHAR](128) NOT NULL,
      [TABLE_SCHEMA] [VARCHAR](128) NOT NULL,
      [TABLE_NAME] [VARCHAR](128) NOT NULL,
      [COLUMN_NAME] [VARCHAR](128) NOT NULL,
	  ...
	  CheckValue [VARCHAR](128) NULL,
CONSTRAINT [PK_ColumnDefaultAndChecks] PRIMARY KEY CLUSTERED 
(	  [DatabaseName] ASC,
      [TABLE_SCHEMA] ASC,
      [TABLE_NAME] ASC,
      [COLUMN_NAME] ASC,
